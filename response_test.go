	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("ResponseJ2X() = %v, want %v", string(got), tt.want)
			}
		})
	}
}
...
func BenchmarkResponseJ2X(b *testing.B) {
	tests := []struct {
		...
		// TODO: Add test cases.
		{"request",
			[]byte(`{"RequestInfo":{"requestId":"0220000245250","userId":"256557","basenumber":"157336","chanelId":"ATM","requestTime":"2203221157"},"CustomerDetails":[{"QID":"27340400282","BASENO":"157336","CRNO":null,"PASSPORTNO":"A1810149","MOBILENO":"","EMAILID":"oyange.george73@gmail.com","GUID":"7c7f7a47-f236-ea11-9132-00505685b1c3","FirstName":"GEORGE ONYANGO","LastName":"OYANGE","IsBlacklisted":false,"IsQANationalityWithdrawn":false}]}`),
